...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-ash/20 mt-20 md:mt-32">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <p className="font-scripture text-sm text-parchment/40 italic leading-relaxed mb-8 max-w-[260px]">
          ...
          <div>
            ...
            <p className="font-scripture text-sm text-parchment/40 italic leading-relaxed mb-8">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  ...
                  required
                  className="w-full bg-transparent border-b border-ash/40 py-2 font-ui text-[11px] text-cream placeholder:text-iron/40 tracking-wider outline-none focus:border-oxblood transition-colors duration-500"
                />
                <button
                  type="submit"
      ...
      <div className="border-t border-ash/10 px-6 md:px-12 lg:px-20 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-8">
          <Link href="#" className="font-ui text-[9px] text-iron/30 tracking-widest uppercase hover:text-iron transition-colors duration-500">
            Privacy
          </Link>
          <Link href="#" className="font-ui text-[9px] text-iron/30 tracking-widest uppercase hover:text-iron transition-colors duration-500">
            Terms
